...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card col-12">
        <div class="d-flex flex-row justify-content-between">   
               <h5 class="card-header">Educateurs</h5>

            <div class="demo-inline-spacing">
                    <a href="index.php?page=educateur&action=add" class="btn rounded-pill btn-primary">Ajouter</a>
                </div>
                </div>
							...
							<td>
								<div class="dropdown">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="index.php?page=educateur&action=show&id=<?= $educateur->getId(); ?>">
											<i class="bx bx-show-alt me-1"></i>
											Show</a>
										<a class="dropdown-item" href="index.php?page=educateur&action=edit&id=<?= $educateur->getId(); ?>">
											<i class="bx bx-edit-alt me-1"></i>
											Edit</a>
										<a class="dropdown-item" href="index.php?page=educateur&action=delete&id=<?= $educateur->getId(); ?>">
