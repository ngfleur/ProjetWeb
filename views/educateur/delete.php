        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.php?page=educateur" class="app-brand-link">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-center min-vh-100">
                        <div class="card col-6 mt-12"> <!-- Ajoutez la classe mt-3 ici -->
                            ...
                            <div class="card-body">
                                <?php if ($educateur): ?>
                                    <div class="alert alert-danger" role="alert">Voulez-vous vraiment supprimer educateur "
                                        <?php echo $educateur->getNom(); ?>" ?
                                    </div>
                                    <form
                                        action="index.php?page=educateur&action=delete&id=<?php echo $educateur->getId(); ?>"
                                        method="post" class="d-flex justify-content-center">
                                        <input type="submit" class="btn rounded-pill btn-danger mx-2" value="Supprimer">
                                        <a class="btn rounded-pill btn-outline-danger mx-2"
