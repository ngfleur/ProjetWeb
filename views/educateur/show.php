					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<div class="d-flex flex-column">
							<div class="card col-12">
								<h5 class="card-header">Educateur</h5>
								<div class="table-responsive text-nowrap">
									<?php if ($educateur): ?>
										<table class="table table-striped">
											<tbody class="table-border-bottom-0">
												<tr>
													<td class="col-3"><i class="fab fa-react fa-lg text-info me-3"></i>
														<strong>Nom :</strong>
													</td>
													<td>
														<?php echo $educateur->getNom(); ?>
													</td>
												</tr>
												<tr>
													<td class="col-3"><i class="fab fa-vuejs fa-lg text-success me-3"></i>
														<strong>Prénom :</strong>
													</td>
													<td>
														<?php echo $educateur->getPrenom(); ?>
													</td>
												</tr>
												<tr>
													<td class="col-3"><i class="fab fa-vuejs fa-lg text-success me-3"></i>
													...
													<td>
														<?php echo $educateur->getNumLicence(); ?>
													</td>
												</tr>
												<tr>
													<td class="col-3"><i class="fab fa-vuejs fa-lg text-success me-3"></i>
														<strong>ID Catégorie :</strong>
													</td>
													<td>
														<?php echo $educateur->getIdCategorie(); ?>
													</td>
												</tr>
												<tr>
													<td class="col-3"><i class="fab fa-react fa-lg text-info me-3"></i>
												...
												<tr>
													...
													<td>
														<input type="checkbox" disabled <?= $educateur->getAdmin() ? 'checked' : '' ?>>
													</td>
													</td>
												</tr>
											</tbody>
							...
							<div class="demo-inline-spacing">
								<a class="btn rounded-pill btn-primary"
									href="index.php?page=educateur&action=delete&id=<?php echo $educateur->getId(); ?>">Supprimer</a>
