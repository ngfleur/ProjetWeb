						...
						<div class="row">
							<div class="col-xl">
								<div class="card mb-4">
									<div class="card-body">
										<form
											action="index.php?page=educateur&action=edit&id=<?php echo $educateur->getId(); ?>"
											method="post">
											<div class="mb-3">
												<label class="form-label" for="num_licence">Numero de licence</label>
												<input type="number" class="form-control" id="num_licence"
													name="num_licence"
													value="<?php echo $educateur->getNumLicence(); ?>" required>
											</div>

											<div class="mb-3">
												<label class="form-label" for="nom">Nom</label>
												<input type="text" class="form-control" id="nom" name="nom"
													value="<?php echo $educateur->getNom(); ?>" required>
											</div>

											<div class="mb-3">
												<label class="form-label" for="prenom">prénom </label>
												<input type="text" class="form-control" id="prenom" name="prenom"
													value="<?php echo $educateur->getPrenom(); ?>" required>
											</div>

											<div class="mb-3">
												<label class="form-label" for="email">Email</label>
												<input type="text" class="form-control" id="email" name="email"
													value="<?php echo $educateur->getEmail(); ?>" required>
											</div>
											...
											<div class="mb-3">
												...
												<select class="form-control" id="id_categorie" name="id_categorie"
													...
													<?php foreach ($categories as $categorie): ?>
														<option value="<?= $categorie->getId() ?>" <?php echo ($categorie->getId() == $educateur->getIdcategorie()) ? 'selected' : ''; ?>>
															<?= $categorie->getNom() ?>
														</option>
													<?php endforeach; ?>
												</select><br>
											...
											<div class="mb-3">
												...
												<input type="password" class="form-control" id="mdp" name="mdp"
													value="<?php echo $educateur->getMdp(); ?>" required>
											</div>

											<div class="mb-3">
												<label class="form-label" for="num_tel">Accès admin</label>
												<input type="checkbox" id="admin" name="admin" <?= $educateur->getAdmin() ? 'checked' : '' ?>>
											</div>
											...
											<div class="demo-inline-spacing">
												...
												<a class="btn rounded-pill btn-outline-primary"
													href="index.php?page=educateur">Retour</a>
											</div>
										</form>
									</div>
								</div>
