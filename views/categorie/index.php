    ...
    <div class="card col-12">
        <div class="d-flex flex-row justify-content-between">   
            ...
            <div class="demo-inline-spacing">
                    <a href="index.php?page=categorie&action=add" class="btn rounded-pill btn-primary">Ajouter</a>
                </div>
                </div>
                        ...
                        <td>
								<div class="dropdown">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="index.php?page=categorie&action=show&id=<?php echo $categorie->getId(); ?>">
											<i class="bx bx-show-alt me-1"></i>
											Show</a>
										<a class="dropdown-item" href="index.php?page=categorie&action=edit&id=<?php echo $categorie->getId(); ?>">
											<i class="bx bx-edit-alt me-1"></i>
											Edit</a>
										<a class="dropdown-item" href="index.php?page=categorie&action=delete&id=<?php echo $categorie->getId(); ?>">
