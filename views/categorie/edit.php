...
<div class="container-xxl flex-grow-1 container-p-y">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Modifier categorie</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <form action="index.php?page=categorie&action=edit&id=<?php echo $categorie->getId(); ?>" method="post">
                        ...
                        <div class="mb-3">
                          <label class="code_raccourci" for="code_raccourci">Code raccourci</label>
                          <input type="text" class="form-control" id="code_raccourci" name="code_raccourci"  value="<?php echo $categorie->getCodeRaccourci(); ?>" required>
                          
                        </div>
                        <div class="demo-inline-spacing">

                        <input type="submit" class="btn rounded-pill btn-primary" name="action" value="Modifier">
