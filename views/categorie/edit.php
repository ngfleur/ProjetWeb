						...
						<div class="row">
							<div class="col-xl">
								<div class="card mb-4">
									<div class="card-body">
										<form
											action="index.php?page=categorie&action=edit&id=<?php echo $categorie->getId(); ?>"
											method="post">
											<div class="mb-3">
												<label class="form-label" for="nom">Nom</label>
												<input type="text" class="form-control" id="nom" name="nom"
													value="<?php echo $categorie->getNom(); ?>" required>
											</div>

											<div class="mb-3">
												<label class="code_raccourci" for="code_raccourci">Code
													raccourci</label>
												<input type="text" class="form-control" id="code_raccourci"
													name="code_raccourci"
													value="<?php echo $categorie->getCodeRaccourci(); ?>" required>
