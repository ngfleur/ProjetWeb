...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-template="vertical-menu-template-free"> <head>
    ...
    <div class="card col-6 mt-12"> <!-- Ajoutez la classe mt-3 ici -->
        ...
        <div class="card-body">
            <?php if ($categorie): ?>
                <div class="alert alert-danger" role="alert">Voulez-vous vraiment supprimer la catégorie "<?php echo $categorie->getNom(); ?>" ?</div>
                <form action="index.php?page=categorie&action=delete&id=<?php echo $categorie->getId(); ?>" method="post" class="d-flex justify-content-center">
                    <input type="submit" class="btn rounded-pill btn-danger mx-2" value="Supprimer">
                    <a class="btn rounded-pill btn-outline-danger mx-2" href="index.php?page=categorie">Retour</a>
                </form>
            <?php else: ?>
