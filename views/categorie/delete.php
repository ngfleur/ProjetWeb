				...
				<div class="content-wrapper">
					...
					<div class="container-xxl d-flex align-items-center justify-content-center min-vh-100">
						<div class="card col-6 mt-12"> <!-- Ajoutez la classe mt-3 ici -->
							...
							<div class="card-body">
								<?php if ($categorie): ?>
									<div class="alert alert-danger" role="alert">Voulez-vous vraiment supprimer la catégorie
										"
										<?php echo $categorie->getNom(); ?>" ?
									</div>
									<form
										action="index.php?page=categorie&action=delete&id=<?php echo $categorie->getId(); ?>"
										...
										<a class="btn rounded-pill btn-outline-danger mx-2"
											href="index.php?page=categorie">Retour</a>
									</form>
								<?php else: ?>
