			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item">
						<a href="index.php?page=licencie" class="menu-link">
							<i class="menu-icon tf-icons bx bx-home-circle"></i>
							<div data-i18n="Analytics">licencies</div>
						</a>
					</li>
			...
			<div class="layout-page">
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						...
						<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Modifier licencie</h4>
						...
						<div class="row">
							<div class="col-xl">
								<div class="card mb-4">
									<div class="card-body">
										<form
											action="index.php?page=licencie&action=edit&id=<?php echo $licencie->getId(); ?>"
											method="post">
											<div class="mb-3">
												<label class="form-label" for="num_licence">Numero de licence</label>
												<input type="number" class="form-control" id="num_licence"
													name="num_licence" value="<?php echo $licencie->getNumLicence(); ?>"
													required>
											</div>
											...
											<div class="mb-3">
												...
												<input type="text" class="form-control" id="nom" name="nom"
													value="<?php echo $licencie->getNom(); ?>" required>
											</div>

											<div class="mb-3">
												<label class="form-label" for="prenom">prénom </label>
												<input type="text" class="form-control" id="prenom" name="prenom"
													value="<?php echo $licencie->getPrenom(); ?>" required>
											</div>
