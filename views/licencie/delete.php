...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-template="vertical-menu-template-free"> <head>
			...
			<div
				...
				<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
					<div class="app-brand demo">
						<a href="index.php?page=licencie" class="app-brand-link">
    ...
    <div class="card col-6 mt-12"> <!-- Ajoutez la classe mt-3 ici -->
        <h5 class="card-header">Supprimer</h5>
        <div class="card-body">
            <?php if ($licencie): ?>
                <div class="alert alert-danger" role="alert">Voulez-vous vraiment supprimer licencie "<?php echo $licencie->getNom(); ?>" ?</div>
                <form action="index.php?page=licencie&action=delete&id=<?php echo $licencie->getId(); ?>" method="post" class="d-flex justify-content-center">
                    <input type="submit" class="btn rounded-pill btn-danger mx-2" value="Supprimer">
                    <a class="btn rounded-pill btn-outline-danger mx-2" href="index.php?page=licencie">Retour</a>
                </form>
            <?php else: ?>
                <p>Le licencié n'a pas été trouvée.</p>
            <?php endif; ?>
        </div>
    </div>
</div>
