							...
							<div class="card col-12">
								<div class="d-flex flex-row justify-content-between">
									...
									<div class="demo-inline-spacing">
										<a href="index.php?page=licencie&action=add"
											class="btn rounded-pill btn-primary">Ajouter</a>
									</div>
								</div>
										...
										<table class="table ">
											...
											<tbody>
												<?php foreach ($licencies as $licencie): ?>
													<tr>
														<td>
															<?php echo $licencie->getNumLicence(); ?>
														</td>
														<td>
														...
														<td>
															<?php echo $licencie->getIdCategorie(); ?>
														</td>
														<td>
															<div class="dropdown">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item"
																		href="index.php?page=licencie&action=show&id=<?php echo $licencie->getId(); ?>">
																		<i class="bx bx-show-alt me-1"></i>
																		Show</a>
																	<a class="dropdown-item"
																		href="index.php?page=licencie&action=edit&id=<?php echo $licencie->getId(); ?>">
																		<i class="bx bx-edit-alt me-1"></i>
																		Edit</a>
																	<a class="dropdown-item"
																		href="index.php?page=licencie&action=delete&id=<?php echo $licencie->getId(); ?>">
