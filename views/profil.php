                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl d-flex flex-column min-vh-100">
                        <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                            <div
                                class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto d-flex align-items-center justify-content-center">
                                <img src="/assets/img/avatars/male.png" alt="user image" width="150" height="150"
                            ...
                            <div class="flex-grow-1 mt-3 mt-sm-5">
                                <div
                                    ...
                                    <a class="btn btn-primary text-nowrap" href='index.php?page=login&action=logout'>
                                        <i class="bx bx-user-check me-1"></i>Deconnexion
                                    </a>
