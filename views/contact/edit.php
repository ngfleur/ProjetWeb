						...
						<div class="row">
							<div class="col-xl">
								<div class="card mb-4">
									<div class="card-body">
										<form
											action="index.php?page=contact&action=edit&id=<?php echo $contact->getId(); ?>"
											method="post">
											<div class="mb-3">
												<label class="form-label" for="nom">Nom</label>
												<input type="text" class="form-control" id="nom" name="nom"
													value="<?php echo $contact->getNom(); ?>" required>
											</div>

											<div class="mb-3">
												<label class="form-label" for="prenom">Prénom </label>
												<input type="text" class="form-control" id="prenom" name="prenom"
													value="<?php echo $contact->getPrenom(); ?>" required>
											</div>

											<div class="mb-3">
												<label class="form-label" for="email">Email </label>
												<input type="email" class="form-control" id="email" name="email"
													value="<?php echo $contact->getEmail(); ?>" required>
											</div>

											<div class="mb-3">
												<label class="form-label" for="num_tel">Numéro de Téléphone </label>
												<input type="tel" class="form-control" id="num_tel" name="num_tel"
													value="<?php echo $contact->getNumTel(); ?>" required>
											</div>

											<div class="mb-3">
												<label class="form-label" for="id_licencie">Licencié :</label>
												<select class="form-control" id="id_licencie" name="id_licencie"
													required>
													<option value="">Sélectionner un licencié</option>
													<?php foreach ($licencies as $licencie): ?>
														<option value="<?= $licencie->getId() ?>"
															<?= $licencie->getId() == $contact->getIdLicencie() ? 'selected' : '' ?>>
															<?= $licencie->getNom() ?>
														</option>
													<?php endforeach; ?>
												</select><br>
											...
											<div class="demo-inline-spacing">
												...
												<a class="btn rounded-pill btn-outline-primary"
													href="index.php?page=contact">Retour</a>
											</div>
										</form>
