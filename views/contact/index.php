							...
							<div class="card col-12">
								<div class="d-flex flex-row justify-content-between">
									...
									<div class="demo-inline-spacing">
										<a href="index.php?page=contact&action=add"
											...
											<tbody>
												<?php foreach ($contacts as $contact): ?>
													<tr>
														...
														<td>
															<?php echo $contact->getNumTel(); ?>
														</td>
														<td>
															<?php echo $contact->getIdLicencie(); ?>
														</td>
														<td>
															<div class="dropdown">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item"
																		href="index.php?page=contact&action=show&id=<?php echo $contact->getId(); ?>">
																		<i class="bx bx-show-alt me-1"></i>
																		Show</a>
																	<a class="dropdown-item"
																		href="index.php?page=contact&action=edit&id=<?php echo $contact->getId(); ?>">
																		<i class="bx bx-edit-alt me-1"></i>
																		Edit</a>
																	<a class="dropdown-item"
																		href="index.php?page=contact&action=delete&id=<?php echo $contact->getId(); ?>">
