...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-template="vertical-menu-template-free"> <head>
			...
			<div
				...
				<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
					<div class="app-brand demo">
						<a href="index.php?page=contact" class="app-brand-link">
    ...
    <div class="card col-6 mt-12"> <!-- Ajoutez la classe mt-3 ici -->
        ...
        <div class="card-body">
            <?php if ($contact): ?>
                <div class="alert alert-danger" role="alert">Voulez-vous vraiment supprimer le contact "<?php echo $contact->getNom(); ?>" ?</div>
                <form action="index.php?page=contact&action=delete&id=<?php echo $contact->getId(); ?>" method="post" class="d-flex justify-content-center">
                    <input type="submit" class="btn rounded-pill btn-danger mx-2" value="Supprimer">
                    <a class="btn rounded-pill btn-outline-danger mx-2" href="index.php?page=contact">Retour</a>
                </form>
            <?php else: ?>
