				...
				<div class="content-wrapper">
					...
					<div class="container-xxl d-flex align-items-center justify-content-center min-vh-100">
						<div class="card col-6 mt-12"> <!-- Ajoutez la classe mt-3 ici -->
							...
							<div class="card-body">
								<?php if ($contact): ?>
									<div class="alert alert-danger" role="alert">Voulez-vous vraiment supprimer le contact "
										<?php echo $contact->getNom(); ?>" ?
									</div>
									<form action="index.php?page=contact&action=delete&id=<?php echo $contact->getId(); ?>"
